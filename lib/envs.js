...
// Match three types of key value pairs - single line and multiline
// single line delimited key value (key=value) |
// double quote multiline (key="value") |
// single quote multiline (key='value')
var envRegularExpression =/([\w]+)=([\w\s][^\n]+)[\n\r]|([\w]+)=["]([^"]+)["]|([\w]+)=[']([^']+)[']/g;
